...
for s=1:999
    fileName = sprintf('WgainPC_%03d.mat',s);
...
%%save ratio_gainPC.mat ALPHA BETA Excitability_all GBCfitt_all FCDfitt_all FCfitt_all Ignition_all ErrDecay_all ErrDecay_all2 Decay_all ErrDecayBold_all;
